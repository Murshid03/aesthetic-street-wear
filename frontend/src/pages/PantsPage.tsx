      ...
      <section className="bg-card border-b border-border">
        <div className="container mx-auto px-4 py-10 lg:py-14">
          ...
          >
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Pants</span>
          </nav>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground max-w-xl leading-relaxed text-sm sm:text-base">
                Precision-tailored fits for every wardrobe. From slim chinos to
                utility cargo silhouettes — each pair engineered to move with
                you through the day.
              </p>
              {isLoading ? (
                ...
                <p className="text-sm text-primary font-semibold mt-3">
                  {pantsList.length} product{pantsList.length !== 1 ? "s" : ""}
                </p>
              )}
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 text-sm">
                Try a different size or browse the full collection
              </p>
