                    ...
                    <div className="flex items-center justify-between w-full gap-4">
                        ...
                        <div className="flex-1 flex items-center gap-2 overflow-x-auto no-scrollbar pb-0.5">
                            ...
                            <button
                                ...
                                className={`px-3.5 py-2 rounded-full text-[9px] font-black uppercase tracking-widest transition-all border shrink-0 ${categoryFilter === "all" ? "bg-black text-white border-black shadow-md shadow-black/5" : "bg-transparent text-black/40 border-black/5 hover:border-black/20"}`}
                            >
                                All
                            </button>
                            {CATEGORY_OPTIONS.map((c) => (
                                <button
                                    ...
                                    className={`px-3.5 py-2 rounded-full text-[9px] font-black uppercase tracking-widest transition-all border shrink-0 ${categoryFilter === c ? "bg-black text-white border-black shadow-md shadow-black/5" : "bg-transparent text-black/40 border-black/5 hover:border-black/20"}`}
                                >
                                    {c}
                                </button>
                            ))}
