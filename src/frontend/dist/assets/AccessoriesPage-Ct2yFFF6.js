...
function AccessoriesPage() {
  ...
  const accessories = reactExports.useMemo(() => {
    const filtered = ALL_PRODUCTS.filter((p) => p.category === "Accessories");
    if (sortBy === "price-asc")
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "nav",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Accessories" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:flex w-12 h-12 rounded-xl bg-primary/10 items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gem, { className: "w-6 h-6 text-primary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl lg:text-5xl font-bold tracking-tight mb-3", children: "Accessories" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl leading-relaxed text-sm sm:text-base", children: "The finishing touches that define your signature style. Timeless watches, belts, scarves, and more — each piece crafted to complete your look with intention." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/30 border-b border-border sticky top-0 z-10 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        "data-ocid": "filter-bar-accessories",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-sm text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-xs hidden sm:inline", children: "Sort:" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: sortBy, onValueChange: setSortBy, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
                ...
                "data-ocid": "sort-select-accessories",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-14 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: accessories.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6", children: accessories.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p, index: i }, p.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 16 },
        animate: { opacity: 1, y: 0 },
        className: "text-center py-24",
        "data-ocid": "empty-state-accessories",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted flex items-center justify-center mx-auto mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gem, { className: "w-8 h-8 text-muted-foreground" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold mb-2", children: "No accessories available" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6 text-sm", children: "Check back soon for new arrivals" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "Back to Home" }) })
        ]
      }
    ) }) })
  ] });
