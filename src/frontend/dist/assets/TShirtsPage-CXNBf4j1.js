...
function TShirtsPage() {
  ...
  const tshirts = reactExports.useMemo(() => {
    let filtered = ALL_PRODUCTS.filter((p) => p.category === "TShirts");
    if (sizeFilter !== "all") {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-10 lg:py-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "nav",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "T-Shirts & Tops" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl lg:text-5xl font-bold tracking-tight mb-3", children: "T-Shirts & Tops" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl leading-relaxed text-sm sm:text-base", children: "Everyday essentials crafted for comfort and effortless style. From relaxed fits to slim-cut silhouettes, built to be worn endlessly across any season." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 lg:py-14 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: tshirts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 lg:gap-6", children: tshirts.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product: p, index: i }, p.id)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 16 },
        animate: { opacity: 1, y: 0 },
        className: "text-center py-24",
        "data-ocid": "empty-state-tshirts",
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-bold mb-2", children: "No T-Shirts found" }),
