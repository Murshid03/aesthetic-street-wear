                ...
                <div className="flex flex-wrap gap-2" data-ocid="size-selector">
                  {product.sizes.map((size) => (
                    <button
                      ...
                      className={`min-w-[48px] px-4 py-2.5 text-sm font-medium rounded-lg border-2 transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
                        activeSize === size
